...
💡 Hands-on experience with real-world datasets and end-to-end ML projects  
...
- Focused on reducing false negatives to improve detection
🛠 Tools
Python | Pandas | NumPy | Scikit-learn | Matplotlib | Seaborn
...
- Created DAX measures for revenue and profit analysis.
🛠 Tools
